...
new_content = """              {/* Bottom Row: A/B Controls */}
              <div className="flex flex-col xl:flex-row items-center justify-between gap-3 bg-[#1e1e1e] rounded-xl p-3 border border-white/5 shadow-sm">
...
if start_idx != -1 and end_idx != -1:
    # Actually, we need to make sure we don't delete too much.
    # The A/B Controls div ends right before `        {/* 書籤紀錄與重點標記 */}`
