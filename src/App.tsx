              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center w-full overflow-hidden touch-none border" style={{ backgroundColor: 'transparent', color: colors.headline, borderColor: colors.stroke }}>
                    ...
                    <input type="text" value={inputA} onChange={(e) => setInputA(e.target.value)} onBlur={applyInputA} onKeyDown={(e) => e.key === 'Enter' && applyInputA()} placeholder="00:00" className="w-full text-center font-mono text-sm sm:text-base md:text-lg font-bold py-3 border-none outline-none bg-transparent min-w-[65px] sm:min-w-[75px] px-0 flex-shrink-0" />
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center w-full overflow-hidden touch-none border" style={{ backgroundColor: colors.background, color: colors.headline, borderColor: colors.stroke }}>
                    ...
                    <input type="text" value={inputB} onChange={(e) => setInputB(e.target.value)} onBlur={applyInputB} onKeyDown={(e) => e.key === 'Enter' && applyInputB()} placeholder="00:00" className="w-full text-center font-mono text-sm sm:text-base md:text-lg font-bold py-3 border-none outline-none bg-transparent min-w-[65px] sm:min-w-[75px] px-0 flex-shrink-0" />
